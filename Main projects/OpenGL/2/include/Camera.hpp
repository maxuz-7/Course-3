...
public:
    ...
    static constexpr GLfloat PITCH_MIN  = -89.0f;
    static constexpr GLfloat PITCH_MAX  =  89.0f;
    static constexpr GLfloat SPEED      =  3.0f;
    static constexpr GLfloat SENSITIVTY =  0.05f;
    static constexpr GLfloat FOV        =  75.0f;
    static constexpr GLfloat FOV_MIN    =  25.0f;
    static constexpr GLfloat FOV_MAX    =  105.0f;
    ...
    {
        if (this->Fov >= FOV_MIN && this->Fov <= FOV_MAX)
            this->Fov -= yoffset;
        if (this->Fov <= FOV_MIN)
            this->Fov = FOV_MIN;
        if (this->Fov >= FOV_MAX)
